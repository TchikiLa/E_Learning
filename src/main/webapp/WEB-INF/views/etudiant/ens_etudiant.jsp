    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800"><fmt:message key="common.etudiants" /></h1>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary"><fmt:message key="etudiant.liste" /></h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                      ...
                      <td>${etudiant.getEmail_etudiant() }</td>
                      <td>
                      		<a href="#"><i class="fa fa-edit">&nbsp;<fmt:message key="common.modifier" /></i></a>
                      		&nbsp;|&nbsp;
                      		<a href="#"><i class="fa fa-trash">&nbsp;<fmt:message key="common.supprimer" /></i></a>
					  </td>
                    </tr>
                  	</c:forEach>
                  </tbody>
